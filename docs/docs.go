...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_horizoonn_todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request or author not found",
                        "schema": {
                            "$ref": "#/definitions/github_com_horizoonn_todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
        ...
        "/users/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "User has related tasks",
                        "schema": {
                            "$ref": "#/definitions/github_com_horizoonn_todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        "github_com_horizoonn_todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Finish math homework by Thursday"
                },
                "title": {
                    "type": "string",
                    "example": "Homework"
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                "author_user_id": {
                    "type": "string",
                    "example": "ba74f37c-1ef1-458f-bd56-f7197ef440ad"
                },
                "completed": {
                    "type": "boolean",
                    "example": false
                ...
                "id": {
                    "type": "string",
                    "example": "3fcef185-f1ef-4259-9bb6-e56b07129c81"
                },
                "title": {
                    "type": "string",
                    "example": "Homework"
